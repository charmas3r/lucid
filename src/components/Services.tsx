              ...
              <Stack gap="md">
                ...
                >
                  <Box
                    style={{
                      ...
                      height: 56,
                      borderRadius: 12,
                      background: 'linear-gradient(135deg, rgba(77, 163, 255, 0.2) 0%, rgba(31, 79, 216, 0.15) 100%)',
                  ...
                  >
                    <service.icon size={26} color="#4DA3FF" stroke={1.5} />
                  </Box>
                </motion.div>
                ...
                <Box>
                  ...
                  <Text
                    ...
                    tt="uppercase"
                    fw={600}
                    style={{ color: '#7A94BA', letterSpacing: '0.5px' }}
                  >
                    {service.subtitle}
                  </Text>
                </Box>
