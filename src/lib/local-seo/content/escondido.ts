...
export const escondidoContent: CityContent = {
  ...
  hub: {
    ...
    heroSubheadline:
      'Modern, fast websites and local search optimization for Escondido businesses. Headquartered right here in Escondido, up in Deer Springs.',
    localIntro: [
      'Lucid Web Studios is headquartered in Escondido, up in the Deer Springs area on the north side of town. We build websites and run local SEO for the restaurants, breweries, wineries, auto shops, and service businesses that actually live and work in the 760. If you can meet up for a coffee and a whiteboard somewhere in town, we can probably get your new site launched before you finish your second one.',
    ...
    localAngle: {
      ...
      body: 'Local means in-person kickoffs at a cafe down the street instead of a Zoom call from another time zone. It means we\u2019ve actually eaten at the restaurants we\u2019re designing sites for. It means faster turnaround, because we\u2019re usually within a 15-minute drive of your business. And it means your Google Business Profile and local citations are managed by somebody who knows the difference between 92025, 92026, and 92029.',
    },
  },
    ...
    faq: [
      {
        ...
        answer:
          'Yes. We\u2019re headquartered up in the Deer Springs area on the north side of Escondido \u2014 not a fly-by-night contractor with a 760 number. We can meet in person at your office, a local cafe, or anywhere in North County.',
      },
      {
  ...
  seoServices: {
    ...
    heroSubheadline:
      'Rank in Escondido search results. Local SEO, Google Business Profile management, and technical SEO from a studio based right here in Escondido.',
    localIntro: [
      ...
      'Our Escondido SEO services are built around how local search actually works in 2026: Google Business Profile optimization, consistent local citations, schema.org structured data, review generation, and content that targets the specific queries Escondido customers are running. We\u2019re a local studio based up in Deer Springs, so we know which neighborhoods to build content around and which nearby cities (Rancho Bernardo, Valley Center, San Marcos) your customers are driving in from.',
    ],
    industries: [
      {
